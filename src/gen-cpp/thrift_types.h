...
public:
	...
	static const char* ascii_fingerprint; // = "15FC7EA6E59A280FE9F157B1FA32D1B4";
	static const uint8_t binary_fingerprint[16]; // = {0x15,0xFC,0x7E,0xA6,0xE5,0x9A,0x28,0x0F,0xE9,0xF1,0x57,0xB1,0xFA,0x32,0xD1,0xB4};
...
public:
	...
	static const char* ascii_fingerprint; // = "52F5995913359E258251DF59F29AD5C9";
	static const uint8_t binary_fingerprint[16]; // = {0x52,0xF5,0x99,0x59,0x13,0x35,0x9E,0x25,0x82,0x51,0xDF,0x59,0xF2,0x9A,0xD5,0xC9};
...
public:
	...
	static const char* ascii_fingerprint; // = "F6CA66A28CB9E033C5AE7708D55945ED";
	static const uint8_t binary_fingerprint[16]; // = {0xF6,0xCA,0x66,0xA2,0x8C,0xB9,0xE0,0x33,0xC5,0xAE,0x77,0x08,0xD5,0x59,0x45,0xED};
...
public:
	...
	static const char* ascii_fingerprint; // = "140AC9E0ADE18AC92D7C273585C7C699";
	static const uint8_t binary_fingerprint[16]; // = {0x14,0x0A,0xC9,0xE0,0xAD,0xE1,0x8A,0xC9,0x2D,0x7C,0x27,0x35,0x85,0xC7,0xC6,0x99};
...
public:
	...
	static const char* ascii_fingerprint; // = "38F19C3EBB548DF1141486652B93ECA2";
	static const uint8_t binary_fingerprint[16]; // = {0x38,0xF1,0x9C,0x3E,0xBB,0x54,0x8D,0xF1,0x14,0x14,0x86,0x65,0x2B,0x93,0xEC,0xA2};
...
public:
	...
	static const char* ascii_fingerprint; // = "89FADE57BA4BE4E58F893F19F83786EF";
	static const uint8_t binary_fingerprint[16]; // = {0x89,0xFA,0xDE,0x57,0xBA,0x4B,0xE4,0xE5,0x8F,0x89,0x3F,0x19,0xF8,0x37,0x86,0xEF};
...
public:
	...
	static const char* ascii_fingerprint; // = "0BFC9374FC386C592F00CB513E034A2B";
	static const uint8_t binary_fingerprint[16]; // = {0x0B,0xFC,0x93,0x74,0xFC,0x38,0x6C,0x59,0x2F,0x00,0xCB,0x51,0x3E,0x03,0x4A,0x2B};
...
public:
	...
	static const char* ascii_fingerprint; // = "FC06559426D8EBA74BAFF48CCE87214E";
	static const uint8_t binary_fingerprint[16]; // = {0xFC,0x06,0x55,0x94,0x26,0xD8,0xEB,0xA7,0x4B,0xAF,0xF4,0x8C,0xCE,0x87,0x21,0x4E};
...
public:
	...
	static const char* ascii_fingerprint; // = "E327E449A3607EF37E6F233EA0CD7372";
	static const uint8_t binary_fingerprint[16]; // = {0xE3,0x27,0xE4,0x49,0xA3,0x60,0x7E,0xF3,0x7E,0x6F,0x23,0x3E,0xA0,0xCD,0x73,0x72};
...
public:
	...
	static const char* ascii_fingerprint; // = "275A89DAC505B54AABB4112E8E14F260";
	static const uint8_t binary_fingerprint[16]; // = {0x27,0x5A,0x89,0xDA,0xC5,0x05,0xB5,0x4A,0xAB,0xB4,0x11,0x2E,0x8E,0x14,0xF2,0x60};
...
public:
	...
	static const char* ascii_fingerprint; // = "9AFD8005C1A991535E7AE2E74CAFE0FD";
	static const uint8_t binary_fingerprint[16]; // = {0x9A,0xFD,0x80,0x05,0xC1,0xA9,0x91,0x53,0x5E,0x7A,0xE2,0xE7,0x4C,0xAF,0xE0,0xFD};
